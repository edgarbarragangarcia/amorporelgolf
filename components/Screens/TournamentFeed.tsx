      ...
      <header className="sticky top-0 z-40 bg-background-light/95 dark:bg-background-dark/95 backdrop-blur-md pt-safe-top">
        <div className="px-5 py-4">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-[32px] font-bold tracking-tight text-gray-900 dark:text-white">Torneos</h1>
          ...
          <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
            <button className="flex-shrink-0 px-5 h-9 rounded-full bg-primary text-white text-sm font-semibold shadow-glow transition-all">Todos</button>
            {['Pro', 'Amateur', 'Benéfico', 'Club'].map(f => (
      ...
      <main className="flex-1 px-4 pt-2 flex flex-col gap-4">
        ...
        <div className="group relative w-full h-[400px] rounded-bento overflow-hidden shadow-soft active:scale-[0.99] transition-transform duration-300 cursor-pointer">
          ...
          <div className="absolute top-4 left-4 flex gap-2">
            <div className="bg-white/20 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-lg flex items-center gap-1.5">
              ...
              <span className="text-white text-xs font-semibold tracking-wide uppercase">12-14 Oct</span>
            </div>
            <div className="bg-primary/80 border border-primary/50 backdrop-blur-md px-3 py-1.5 rounded-lg flex items-center gap-1.5">
              <span className="text-white text-xs font-bold tracking-wide uppercase">Destacado</span>
            </div>
          </div>
          <div className="absolute bottom-0 left-0 w-full p-5 flex flex-col gap-2">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-primary font-medium text-sm mb-1 tracking-wide uppercase">División Pro</p>
                <h2 className="text-white text-3xl font-bold leading-none mb-1">Abierto de la Costa</h2>
            ...
            <div className="flex items-center justify-between mt-3 pt-4 border-t border-white/10">
              <div className="flex flex-col">
                <span className="text-gray-400 text-xs uppercase tracking-wider">Inscripción</span>
        ...
        <div className="relative h-24 rounded-bento bg-white dark:bg-card-dark shadow-soft p-3 flex items-center gap-4 cursor-pointer active:bg-gray-50 dark:active:bg-zinc-800 transition-colors border border-gray-100 dark:border-zinc-800">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="flex justify-between items-start w-full">
              <div className="flex flex-col">
                <h3 className="text-gray-900 dark:text-white font-bold text-base leading-tight">Clasificatorio Masters</h3>
                <p className="text-gray-500 dark:text-gray-400 text-xs mt-0.5">Augusta National • 05 Nov</p>
              </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-1 h-[160px] rounded-bento bg-primary p-4 flex flex-col justify-between relative overflow-hidden shadow-glow">
            ...
            <div>
              <p className="text-green-900 font-bold text-xs uppercase tracking-wider opacity-60">Tu Temporada</p>
              <p className="text-white font-bold text-3xl mt-1">3º</p>
              <p className="text-white text-xs opacity-90">Ranking Actual</p>
            </div>
          ...
          <div className="col-span-1 h-[160px] rounded-bento bg-white dark:bg-card-dark shadow-soft p-4 flex flex-col justify-between relative overflow-hidden border border-gray-100 dark:border-zinc-800">
            <div className="flex justify-between items-start">
              ...
              <span className="text-xs font-bold text-gray-400">Sab, 12 Oct</span>
            </div>
            <div>
              <p className="text-gray-900 dark:text-white font-bold text-lg">Soleado</p>
              <p className="text-gray-500 dark:text-gray-400 text-xs">22°C • Viento 8km/h</p>
            </div>
          </div>
        </div>
      </main>
