    ...
    <div className="relative flex h-full min-h-screen w-full flex-col pb-24">
      ...
      <div className="sticky top-0 z-30 flex items-center justify-between px-6 pt-6 pb-2 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">Buenos Días</span>
      ...
      <main className="flex-1 px-4 pt-2">
        ...
        <div className="flex items-center gap-2 mb-6 px-2 opacity-70">
          ...
          <span className="text-xs font-medium text-gray-500 dark:text-gray-400">22°C • Pebble Beach, CA</span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between p-5">
              ...
              <div>
                <p className="text-primary font-bold text-sm mb-1 tracking-wide uppercase">12-14 Oct</p>
                <h3 className="text-3xl font-bold text-white tracking-tight leading-tight mb-2">Campeonato<br/>del Club</h3>
          ...
          <div className="col-span-1 flex flex-col justify-between rounded-bento bg-white dark:bg-card-dark p-5 shadow-sm border border-gray-100 dark:border-gray-800 transition-colors">
            ...
            <div>
              <p className="text-gray-500 dark:text-gray-400 text-xs font-medium uppercase tracking-wide mb-1">Hándicap</p>
          ...
          >
            ...
            <div className="mt-4">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Tu Caddie</p>
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-center px-6 py-4 w-2/3">
              <span className="text-primary font-bold text-xs tracking-wider uppercase mb-2">Recién Llegado</span>
              <h3 className="text-2xl font-bold text-white mb-2 leading-tight">El Nuevo<br/>Titleist TSi3</h3>
              <p className="text-gray-300 text-sm mb-4 line-clamp-2">Rendimiento de precisión para el jugador dedicado.</p>
          ...
          <div className="col-span-2 mt-2">
            <div className="flex justify-between items-center mb-3 px-1">
              <h4 className="font-bold text-sm text-gray-900 dark:text-white">Consejos Pro</h4>
              <button className="text-primary text-xs font-medium">Ver Todo</button>
            </div>
            <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
              <div className="min-w-[200px] bg-white dark:bg-card-dark rounded-xl p-3 shadow-sm border border-gray-100 dark:border-gray-800">
                <div className="flex gap-3 items-center">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-gray-900 dark:text-white">Tempo del Swing</span>
                    <span className="text-[10px] text-gray-500">3 min lectura</span>
                  </div>
                </div>
              </div>
              <div className="min-w-[200px] bg-white dark:bg-card-dark rounded-xl p-3 shadow-sm border border-gray-100 dark:border-gray-800">
                <div className="flex gap-3 items-center">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-bold text-gray-900 dark:text-white">Juego Mental</span>
                    <span className="text-[10px] text-gray-500">5 min lectura</span>
                  </div>
                </div>
              </div>
            </div>
